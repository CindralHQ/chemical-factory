  ...
  return (
    <div className="bg-base-100 text-base-content font-sans">
      ...
      <section className="relative w-full h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        />
        <div className="relative z-20 text-center space-y-4 px-4 animated fade-in-up">
          <p className="text-secondary tracking-[0.3em] uppercase text-sm font-bold">
          ...
          <p className="text-gray-200 text-lg md:text-xl max-w-2xl mx-auto font-light">
            Crafting the future of aroma and chemical synthesis.
          </p>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-base-content/80 leading-relaxed">
              Specializing in high-purity aroma chemicals, pheromone intermediates, specialty molecules, and custom research solutions. With a strong foundation in chemical synthesis, process optimization, and quality compliance, we enable global industries to access reliable, scalable, and innovation-driven intermediates.
            </p>
            <p className="text-lg text-base-content/80 leading-relaxed">
          ...
          <div className="relative">
            ...
            <img
              ...
              alt="Lab Research"
              className="relative rounded-3xl shadow-2xl border border-white/20 w-full object-cover h-[500px]"
            />
          </div>
        </div>
      </section>
              ...
              <div className="bg-base-100/10 p-8 rounded-3xl border border-white/10 backdrop-blur-md">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-4 border-b border-white/10 pb-3 last:border-0">
                      <span className="bg-green-500/20 text-green-400 rounded-full p-1 mt-1">
